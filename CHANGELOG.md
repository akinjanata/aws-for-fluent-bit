...
* Amazon Linux 2 base container image version: 2.0.20260330.0

Compared to the previous release, this release adds:
* Fix image tags for dockerhub/public ecr [#1099](https://github.com/aws/aws-for-fluent-bit/pull/1099)
* Update test image sync to only pull for published images [#1098](https://github.com/aws/aws-for-fluent-bit/pull/1098)
